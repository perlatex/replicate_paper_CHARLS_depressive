...
mydataIMP %>% count(type_number) # facility 
...
semmodel_LPA <- "
  ...
  LPA        ~ type_number
  IADL       ~ LPA + type_number
  depression ~ IADL + LPA + type_number

"

fit_sem_LPA_unconstr <- sem(semmodel_LPA,
      data        = mydataIMP,
      group       = "urban_nbs",
      estimator   = "ML",
      mimic       = "Mplus"
...
fit_sem_LPA_constr <- sem(semmodel_LPA,
      data          = mydataIMP,
      group         = "urban_nbs",
      group.equal   = c("depression ~ type_number", 
                        "depression ~ IADL"),
      estimator     = "ML",
      mimic         = "Mplus"
)
...
semmodel_TPA <- "
  ...
  TPA        ~ type_number
  IADL       ~ TPA + type_number
  depression ~ IADL + TPA + type_number

"

fit_sem_TPA_unconstr <- sem(semmodel_TPA,
            data        = mydataIMP,
            group       = "urban_nbs",
            estimator   = "ML",
            mimic       = "Mplus")
...
fit_sem_TPA_constr <- sem(semmodel_TPA,
            data          = mydataIMP,
            group.partial = c("depression ~ type_number", 
                              "IADL       ~ TPA",
                              "depression ~ TPA",
